...
export default function DeleteBrandButton({ brandId, brandName, hasProducts }) {
  ...
  if (hasProducts) {
    return (
      <button
        disabled
        title={`No se puede eliminar ${brandName} porque tiene productos asociados`}
