  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 right-4 z-40 bg-black text-white p-3 rounded-full shadow-lg hover:bg-gray-800 transition-all duration-200 flex items-center gap-2"
      >
      ...
      {/* Panel Lateral */}
      <div className={`fixed top-0 right-0 h-full w-80 bg-white dark:bg-gray-900 z-50 shadow-xl transform transition-transform duration-300 overflow-y-auto ${
        ...
        <div className="p-6 space-y-6">
          ...
          {/* 1. Filtro de Género */}
          <div>
            <h3 className="text-sm font-medium text-gray-900 dark:text-white mb-3">Género</h3>
              ...
              {['hombre', 'mujer', 'unisex'].map((gender) => (
                <label key={gender} className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 text-black focus:ring-black border-gray-300 dark:border-gray-600"
                  />
          ...
          {selectedGender && (
            <div>
              <h3 className="text-sm font-medium text-gray-900 dark:text-white mb-3">Marca</h3>
          ...
          {selectedGender && (
            <div>
              <h3 className="text-sm font-medium text-gray-900 dark:text-white mb-3">Categoría</h3>
              <div className="space-y-2 max-h-48 overflow-y-auto">
