export default function Loading() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-stone-100">
      {/* Header Skeleton */}
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          <div className="grid lg:grid-cols-2 gap-0">
            {/* Image Skeleton */}
            <div className="relative aspect-square bg-gradient-to-br from-gray-50 to-stone-100 animate-pulse">
              <div className="absolute top-6 left-6 bg-gray-200 rounded-full h-10 w-32 animate-pulse"></div>
            ...
            <div className="p-8 lg:p-12">
              <div className="h-full flex flex-col">
                ...
                <div className="mb-6">
                  <div className="bg-gray-100 rounded h-12 w-3/4 mb-4 animate-pulse"></div>
                  <div className="flex items-center gap-4 mb-6">
                    <div className="bg-gray-200 rounded h-16 w-32 animate-pulse"></div>
                    <div className="bg-gray-100 rounded-full h-12 w-24 animate-pulse"></div>
                  </div>
                </div>

                {/* Description Skeleton */}
                <div className="flex-grow mb-8">
                  <div className="bg-gray-100 rounded h-6 w-48 mb-4 animate-pulse"></div>
                ...
                <div className="mb-8">
                  <div className="bg-gray-100 rounded h-6 w-40 mb-4 animate-pulse"></div>
                  <div className="grid sm:grid-cols-2 gap-4">
                    {[...Array(4)].map((_, i) => (
                      <div key={i} className="bg-gray-50 border border-gray-200 p-4 rounded-lg">
                        <div className="bg-gray-100 rounded h-4 w-20 mb-2 animate-pulse"></div>
                        <div className="bg-gray-200 rounded h-6 w-24 animate-pulse"></div>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                {/* Features Skeleton */}
                <div className="mb-8">
                  <div className="bg-gray-100 rounded h-6 w-32 mb-4 animate-pulse"></div>
                  <div className="space-y-3">
                    {[...Array(4)].map((_, i) => (
                ...
                <div className="space-y-4">
                  <div className="bg-gray-200 rounded-lg h-14 animate-pulse"></div>
          ...
          {[...Array(3)].map((_, i) => (
            <div key={i} className="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
              <div className="text-center">
                <div className="w-12 h-12 bg-gray-100 rounded-full mx-auto mb-4 animate-pulse"></div>
                <div className="bg-gray-100 rounded h-5 w-24 mx-auto mb-2 animate-pulse"></div>
