        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            ...
            <div className="flex justify-center items-center mb-4">
              ...
              <Link 
                href="/"
                className="text-3xl md:text-4xl font-light tracking-wider text-black hover:text-black transition-colors duration-200 cursor-pointer"
              >
                {siteConfig.siteName}
              </Link>
            </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {brandProducts.map(product => (
                      <Link
                        ...
                        className="group bg-white rounded-xl shadow-sm border border-black overflow-hidden hover:shadow-lg transition-all duration-300"
                      >
                        {/* Imagen */}
                        ...
                        <div className="p-4">
                          <h4 className="font-medium text-black line-clamp-2 group-hover:underline transition-all">
                            {product.name}
                          </h4>
