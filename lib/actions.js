...
export async function getProducts(sizeFilter = null, categoryFilter = null, genderFilter = null, brandFilter = null) {
  try {
    ...
    console.log('Filters received:', { sizeFilter, categoryFilter, genderFilter, brandFilter })
    ...
    if (categoryFilter) {
      // Si categoryFilter es numérico, buscar por ID, sino por slug
      if (!isNaN(categoryFilter)) {
        where.categoryId = parseInt(categoryFilter)
        console.log('Filtering by category ID:', parseInt(categoryFilter))
      } else {
        where.categoryRel = {
          slug: categoryFilter
        }
    ...
    if (brandFilter) {
      ...
      console.log('Filtering by brand ID:', parseInt(brandFilter))
    }
