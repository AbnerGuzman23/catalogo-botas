...
export async function getProducts(sizeFilter = null, categoryFilter = null) {
  try {
    console.log('🔍 getProducts called with filters:', { sizeFilter, categoryFilter })
    ...
    console.log('📋 Products preview:', products.map(p => ({ id: p.id, name: p.name, category: p.category, categoryRel: p.categoryRel?.name })))
